...
namespace BTMang
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("Bai59: Nhap vào năm Dương lich, xuat tên năm Âm lich. Xuất năm Dương lich ke tiep có cùng tên năm Âm lich");
                Console.WriteLine("Bai61: Viet chuong trinh thuc hien nhung yeu cau sau");
                Console.WriteLine("Bai62: Viet chuong trinh thuc hien nhung yeu cau sau");
                Console.WriteLine("Bai63: Viet chuong trinh thuc hien nhung yeu cau sau");
                Console.WriteLine("Bai66: Viet chuong trinh thuc hien nhung yeu cau sau");
